...
import com.example.assistease.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun ExtractTextRead() {
        binding.extrctText.setOnClickListener {
            findNavController().navigate(R.id.action_homeFragment_to_extractText)
        }
    }
...
//            voiceCommand.equals("see notification", ignoreCase = true) -> showNotifications()
