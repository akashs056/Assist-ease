...
import com.example.assistease.databinding.FragmentVoiceControlBinding
import java.util.Locale


class VoiceControl : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding= FragmentVoiceControlBinding.inflate(inflater,container,false)
        onBackClicked()
        onVoiceClicked()
    ...
    private fun onBackClicked() {
        binding.toolbar.setNavigationOnClickListener {
            findNavController().navigate(R.id.action_voiceControl2_to_homeFragment2)
        }
    }
